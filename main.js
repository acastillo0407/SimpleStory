...
function getStory(name, age) {
  return {
    ...
    kennelEnding: {
      ...
      story: `Well <span class="green">${name}</span>, you chose to break out <span class="blue">Phido</span>. You were caught, and now you suffer his same consequence. Additionally, This is somewhat similar to what happens to Antigone. You could not withstand the thought of <span class="blue">Phido</span> being trapped in a kennel. It was your belief that as a brother to <span class="blue">Phido</span> (as well as recognizing the wrongful nature of being locked up), you should free him. At any rate, here is the actual version of the story: <br><br>
    ...
    leavePhidoEnding: {
      ...
      story: `Well <span class="green">${name}</span>, you did not break out <span class="blue">Phido</span>... so life goes on for you and <span class="blue">Creyawn</span>. Hey, I guess this does not end in tragedy. I mean, the rules are the rules. We can't have the animals running around angry because <span class="blue">Phido</span> recieved favoritism, right? I mean, he also did ignore the rules! Anyways. The key Difference between your version and the actual version: Antigone had a strong belief on what she felt was right. She was firm on choosing divine law over human law. She was also set on choosing her family, against the laws of the state. Thus, if you were to rescue Phido, you would be in line with Antigone in some sense. Although you did not, there is still much to discuss! You may still consider the thought of choosing what the state law wants you to choose, versus what you feel is morally right. At any rate, here is the actual version of the story: <br><br>
      After Antigone's brothers kill each other in a battle for the throne of Thebes, Creon saw the perfect oppurtunity to take the throne. King Creon (their uncle and Antigone's uncle) decrees that Polyneices, who had fought against Thebes, is not to be given a proper burial. Antigone defies this decree and buries her brother's body, believing that it is her duty as a sister and as a devout believer in the gods to honor the dead. Creon orders Antigone to be punished for her disobedience, and she is sentenced to death. As for Creon: well his entire family dies. The burden of losing Antigone became too strong to withstand.Thus, his wife Eurydice and his son Haemon (who was to marry Antigone), both take their own lives.`,
      defaultDestination: "start",
      buttonText: "Back to the start!",
    },
